...
## 受众(账号真实画像,2026-07后台数据: 哑铃型+北方下沉+安卓86%)
最大群体=31-40岁打工人/宝妈(30%),其次12-23岁学生党(36%合计),50+也有14%。金句说中的人群要【逐日轮换】:
- 中年打工人/宝妈(最大组,优先): "哄睡了娃,才轮到自己的那两小时" / "下了夜班,进门不敢开灯"
- 学生党: 考试周熬夜/晚自习回家/被作业追着跑
- 上班青年: 下晚班/挤末班车/电动车到楼下多坐五分钟
- 通用: 被家里人念叨/一天没说上一句真心话
语言接地气(北方口语感),⛔别写都市白领腔(KPI/会议/咖啡)。
...
2. "candidates": 10句候选【正向治愈金句】,每句≤20字。要求:
   ...
   - 【点赞扳机=说中,不是安慰】必须具体到一个"微瞬间"——那种没人说过但人人都干过的小动作/小心理。
     泛泛安慰(❌"今天也辛苦了,歇会儿吧")远弱于精确看穿(✅"到楼下了,却在电动车上多坐了五分钟。")
   - ⛔禁止: 丧/摆烂/躺平/emo/负能量/说教/俗套鸡汤(如"加油""明天会更好"直接淘汰)
   - 好的样子: "到楼下了,却在电动车上多坐了五分钟。" / "晚自习回家,书包一扔先躺两分钟。" / "慢一点没关系,又不是只有你在赶路。"
