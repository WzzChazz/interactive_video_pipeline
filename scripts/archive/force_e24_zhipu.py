...
from main import stage_generate_images, stage_generate_videos, stage_generate_audio_and_compile
...
def run_e24():
    ...
    print("Generating Native HD Images via Zhipu...")
    stage_generate_images(script, ep)
    
    print("Generating Videos via Aliyun Wan...")
