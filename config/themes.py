...
THEMES = {
    ...
    "capybara_healing": {
        ...
        # 【2026-07-03 画风切3D】依据:拆解8条爆款(水豚噜噜3条百万级)全部是3D渲染,赢家样本里动漫插画风=0;
        # 自己号2秒跳出65%+封面点击0%指向画面资产本身不过线 → 切到被验证的画风。切换后需重生成3D定妆照(scripts/make_3d_hero.py)
        "visual_style": "Cozy healing 3D CARTOON RENDER aesthetic — Pixar-style / blind-box figurine (泡泡玛特) quality, soft rounded shapes, chubby adorable proportions, fluffy fur with visible soft texture, warm pastel cream palette, soft golden lighting, gentle global illumination, kawaii and wholesome. Settings: sunny windowsill, cozy cafe, blanket nest, autumn park, lakeside, warm hot spring. Everything soft, warm, slow and comforting. NO harsh shadows, NO dark scenes, NO live-action photorealism, NO flat 2D anime style.",
        # 【2026-07-03 单主角化】拆解8条爆款无一双主角(全是动物独角);林溪稀释萌浓度+一致性难度翻倍 → 团团solo为默认
        "character_prompt_lock": "cute 3D cartoon render, Pixar-style blind-box figurine aesthetic, soft global illumination, featuring Tuan Tuan as the SOLO main character (an EXTRA cute round chubby fluffy 3D capybara with big adorable round eyes, a soft derpy cute face and huggable plush-like fur, large and centered in frame), kawaii, warm cozy healing aesthetic, consistent character design; a human presence may appear ONLY off-screen style (a hand offering a snack, a blanket being tucked) and never a face",
