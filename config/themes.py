...
THEMES = {
    ...
    "capybara_healing": {
        ...
        "character_prompt_lock": "cute 3D cartoon render, Pixar-style blind-box figurine aesthetic, soft global illumination, featuring two recurring characters — Lin Xi (a 20 years old youthful cute pretty asian girl in stylized 3D cartoon proportions, soft long wavy black hair, big bright lively sparkling eyes, sweet playful cheerful smile, fair clear skin, cozy cream HIGH-NECK knit sweater, modest fully covered wholesome outfit) and her pet Tuan Tuan (an EXTRA cute round chubby fluffy 3D capybara with big adorable round eyes, a soft derpy cute face and huggable plush-like fur), kawaii, warm cozy healing aesthetic, characters naturally placed within the spacious scene (NOT always crammed close together), consistent character design",
