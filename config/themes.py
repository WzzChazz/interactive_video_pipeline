...
THEMES = {
    "hospital_horror": {
        ...
        "visual_style": "Clinical Melancholy aesthetic. Symmetrical, spotless, blindingly white or cold blue hospital spaces, sterile environment, eerie emptiness. Example: 'wide symmetrical shot of an abandoned underground archive, cold flickering fluorescent lighting, utterly empty, clinical melancholy, 35mm lens'",
